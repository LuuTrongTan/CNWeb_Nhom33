    ...
    <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      {!user?.isVerified && (
        <div className="bg-yellow-100 text-yellow-800 p-2 rounded mb-4">
          ...
          <button className="text-blue-500 underline ml-2" onClick={handleRequestVerification}>
            Xác thực ngay
          </button>
        </div>
      )}

      {showVerificationModal && <VerifyEmailModal onClose={() => setShowVerificationModal(false)} email={user.email} />}
