        ...
        for (const productId of uniqueProductIds) {
          try {
            ...
            if (product) {
              ...
              console.log(`Loaded product ${productId}:`, product);
            } else {
    ...
    <div className="cartpage-container">
      ...
      {cart.length === 0 ? (
        <div className="cartpage-empty">
          ...
          <button className="cartpage-shop-btn" onClick={() => navigate("/products")}>
        ...
        <>
          <div className="cartpage-list">
            ...
            {cart.map((item) => {
              ...
              return (
                <div key={itemId} className={`cartpage-item ${isSelected ? 'selected' : ''}`}>
                  <div className="cartpage-checkbox">
                    ...
                    />
                    <label htmlFor={`select-item-${itemId}`} className="checkbox-label">
                      <span className="checkbox-custom">
                            ...
                            <div className="cartpage-sizes-list">
                              {localCart[item.id].sizes.map((size, idx) => (
                                <span
                                  ...
                                  onClick={() => handleSizeChange(itemId, size)}
                                >
                                  {size}
                                </span>
                              ))}
                            ...
                            <div className="cartpage-colors-list">
                              {localCart[item.id].colors.map((color, idx) => (
                                <span
                                  ...
                                  onClick={() => handleColorChange(itemId, color)}
                                >
                                  {color}
                                </span>
                              ))}
                    ...
                    {item.hasDiscount ? (
                      <>
                        <div className="cartpage-sale-price">
                          {item.price.toLocaleString()} <span className="cartpage-currency">₫</span>
                        </div>
                        <div className="cartpage-original-price">
                          {item.originalPrice.toLocaleString()} <span className="cartpage-currency">₫</span>
                        </div>
                  ...
                  <div className="cartpage-total-section">
                    <div className="cartpage-item-total">
                      {(item.price * item.quantity).toLocaleString()} <span className="cartpage-currency">₫</span>
                    </div>
                  </div>
