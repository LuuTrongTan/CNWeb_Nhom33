...
//     const apiKey = config.goong.apiKey;
//     const response1 = await forwardGeocoding(address1);
//     const lat1 = response1.data.results.geometry.location.lat;
//     const lng1 = response1.data.results.geometry.location.lng;
//     const response2 = await forwardGeocoding(address2);
//     const lat2 = response2.data.results.geometry.location.lat;
//     const lng2 = response2.data.results.geometry.location.lng;
//     console.log(lat1);
