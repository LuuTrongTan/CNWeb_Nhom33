// BACKUP - KHÔNG SỬ DỤNG FILE NÀY
// File này được giữ lại như một mẫu ví dụ nhưng không sử dụng trong dự án
// Sử dụng src/index.js làm entrypoint chính của ứng dụng
// ===================================================================
